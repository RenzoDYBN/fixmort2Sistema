...
g.messageTop+k+k+i);g.messageBottom&&(i=i+k+k+g.messageBottom);b.customize&&(i=b.customize(i,b,c));b=h("<textarea readonly/>").val(i).appendTo(d);if(j.queryCommandSupported("copy")){d.appendTo(c.table().container());b[0].focus();b[0].select();try{var f=j.execCommand("copy");d.remove();if(f){c.buttons.info(c.i18n("buttons.copyTitle","Copiado en el portapapeles"),c.i18n("buttons.copySuccess",{1:"Se ha copiado una fila en el portapapeles",_:"Se ha copiado %d filas al portapapeles"},a.rows),2E3);this.processing(!1);return}}catch(l){}}f=
